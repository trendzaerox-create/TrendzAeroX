...
//     console.log("Newsletter email:", email.trim());
//     setEmail("");
//   };
...
//       <button
//         type="submit"
//         className="h-[52px] rounded-full bg-white px-8 text-[12px] font-bold uppercase tracking-[0.18em] text-black transition-all duration-200 hover:bg-gray-200 sm:min-w-[165px]"
//       >
//         Subscribe →
//       </button>
//     </form>
...
//               <Link
//                 href="/"
//                 className="text-[18px] font-bold uppercase tracking-[0.22em] text-white"
//               >
//                 Trendz AeroX
//               </Link>
//             </div>
