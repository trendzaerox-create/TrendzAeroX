...
//   const [shiprocketOrder, setShiprocketOrder] =
//     useState(null);
...
//     } catch (err) {
//       setError(
//         err.message || "Failed to load Shiprocket details"
//       );
//     } finally {
//       setLoading(false);
//     }
...
//       setSuccess(
//         result?.status
//           ? `Tracking refreshed. Current status: ${statusText(
//               result.status
//             )}`
...
//       setError(
//         err.message ||
//           "Failed to refresh Shiprocket tracking"
//       );
//     } finally {
//       setRefreshing(false);
//     }
...
//           <p className="mt-2 text-sm text-[#666666]">
//             Create the shipment in Shiprocket, assign
//             AWB, generate pickup, and refresh tracking
...
//                       Live status from Shiprocket webhook
//                       or manual tracking refresh.
//                     </p>
//                   </div>
...
//                       value={
//                         shiprocketOrder.latestActivity ||
//                         "—"
//                       }
//                     />
...
//                       value={
//                         shiprocketOrder.latestLocation ||
//                         "—"
//                       }
//                     />
...
//                       value={formatDate(
//                         shiprocketOrder.expectedDeliveryAt
//                       )}
//                     />
...
//                   <p className="mt-1 text-sm text-[#666666]">
//                     These details are visible to the
//                     customer order page.
//                   </p>
...
//                   <p>
//                     <b>Webhook:</b> Shiprocket will update
//                     this order automatically when tracking
//                     status changes.
//                   </p>

//                   <p>
//                     <b>Manual refresh:</b> Use “Refresh
//                     Tracking Now” when you want to check the
//                     latest AWB status immediately.
//                   </p>

//                   <p>
//                     <b>Scheduler backup:</b> Your backend can
//                     refresh open shipments automatically every
//                     30 minutes.
//                   </p>
//                 </div>
//               </div>
...
export default function ShiprocketCreateClient({ orderId }) {
  ...
  async function createShiprocketOrder() {
    try {
      ...
      const payload = {
        pickupLocation:
          form.pickupLocation?.trim() || DEFAULT_PICKUP_LOCATION,
        lengthCm: toNumberOrNull(form.lengthCm),
        breadthCm: toNumberOrNull(form.breadthCm),
        heightCm: toNumberOrNull(form.heightCm),
        weightKg: toNumberOrNull(form.weightKg),
